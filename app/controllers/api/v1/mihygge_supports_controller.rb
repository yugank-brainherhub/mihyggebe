module Api
  module V1
    class MihyggeSupportsController < API::V1::ApplicationController
      ...
      private
        ...
        def mihygge_support_params
          params.require(:mihygge_support).permit(:support_type, :description, :file_1, :user_id, :email, :phone_number, :first_name, :last_name, :support_number, :is_provider, :provider_id, :subject, :category, :booking, :referance)
        end
    end
  end
end    
