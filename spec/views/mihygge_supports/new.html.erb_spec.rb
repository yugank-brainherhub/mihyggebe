...
RSpec.describe "mihygge_supports/new", type: :view do
  before(:each) do
    assign(:mihygge_support, MihyggeSupport.new(
  ...
  it "renders new mihygge_support form" do
    render

    assert_select "form[action=?][method=?]", mihygge_supports_path, "post" do
